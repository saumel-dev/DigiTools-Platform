        ...
        <>
            {
                selectedProd.length === 0 ? <div className='container flex flex-col justify-center items-center mx-auto shadow-sm rounded-xl mt-10 h-100'>
                    ...
                    : <div className='container mx-auto shadow-sm rounded-xl mb-10 mt-10 px-10'>
                        ...
                        {
                            setSelectedProd.length != 0 ? <div className='justify-center items-center flex'> <button onClick={handleProceed} className='cursor-pointer hover:-translate-y-1 transition-all w-10/12 my-5 py-3 border-none shadow-sm rounded-xl bg-red-400 text-xl text-white font-bold'>Proceed to buy</button></div> : ""
                        }
                    </div >
            }
        </>
