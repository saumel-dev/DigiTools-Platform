            ...
            <div className='grid xl:grid-cols-3 justify-items-center gap-5'>
                <div className="card w-96 bg-base-100 shadow-sm hover:-translate-y-3 transition-all">
                    <div className="card-body rounded-3xl">
                        ...
                        <div className="mt-6">
                            <button className="rounded-full p-3 text-white bg-linear-to-b from-[#4F39F6] to-[#9514FA] hover:-translate-y-1 transition-all btn-block">Get Started Free</button>
                        </div>
                    </div>
                </div>
                <div className="card w-96 bg-base-100 shadow-sm hover:-translate-y-3 transition-all text-white relative">
                    ...
                    <div className="card-body rounded-3xl bg-linear-to-b from-[#4F39F6] to-[#9514FA]">
                        ...
                        <div className="mt-6">
                            <button className="rounded-full p-3 text-white bg-white hover:-translate-y-1 transition-all btn-block"><span className='bg-linear-to-b from-[#4F39F6] to-[#9514FA] bg-clip-text text-transparent'>Start Pro Trial</span></button>
                        </div>
                    </div>
                </div>
                <div className="card w-96 bg-base-100 shadow-sm hover:-translate-y-3 transition-all">
